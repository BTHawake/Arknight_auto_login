...
* **极致轻量**：剥离了所有臃肿的本地配置和消息推送代码，只保留最纯粹的签到请求。
...
### 第一步：配置 Token (最重要的步骤)
为了安全，我们千万**不要**把 Token 直接写在代码里，而是使用 GitHub 提供的密钥管理功能。
...
根据 `.github/workflows/sign-in.yml` 中的配置，脚本会在**每天北京时间早上 8:00 (UTC 0:00)** 自动醒来为你签到。
